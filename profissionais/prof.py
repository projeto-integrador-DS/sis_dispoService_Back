...
#============EXPERIÊNCIAS==============
@prof_blueprint.route('/experiencia', methods=['POST', 'GET'])
def cad_experiencia():
...
@prof_blueprint.route('/lista_experiencias/<int:id_profiss>')
...
@prof_blueprint.route('/add_exper/<int:id_profiss>', methods=['POST', 'GET'])
...
@prof_blueprint.route('/edit_experiencias/<int:idExperiencia>', methods=["POST", "GET"])
...
@prof_blueprint.route('/delete_experiencia/<int:idExperiencia>', methods=['GET'])
